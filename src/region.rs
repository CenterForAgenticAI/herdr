...
impl RegionInstance {
    ...
    pub fn bounds(&self) -> RegionSizeBounds {
        self.bounds
    }
...
impl RegionState {
    ...
    pub fn get_by_id_mut(&mut self, region_id: &str) -> Option<&mut RegionInstance> {
        self.session
            .values_mut()
            .find(|instance| instance.region_id.as_str() == region_id)
    }
    ...
    pub fn find_by_pane(&self, pane_id: crate::layout::PaneId) -> Option<&RegionInstance> {
        self.session
            .values()
