...
pub struct RegionConfig {
    ...
    /// User config wins over the plugin manifest. Default: 32.
    pub size: u16,
...
impl Default for RegionConfig {
    fn default() -> Self {
        Self {
            enabled: true,
            size: crate::region::DEFAULT_REGION_SIZE,
            start_hidden: false,
        }
    }
}
...
"#;
    ...
    fn regions_default_to_an_enabled_visible_right_region() {
        ...
        assert_eq!(config.ui.regions.right.size, 32);
